...
export function TarjetaD() {
  return (
    <Card className="text-white shadow-[0_10px_20px_rgba(0,0,0,0.2)] cursor-pointer hover:contrast-100 hover:scale-110 duration-150">
      <CardContent className="w-full flex items-center bg-[rgb(213,174,54)] p-0">
      ...
      <CardFooter className="flex items-center justify-center bg-[rgb(183,135,67)] py-2">
