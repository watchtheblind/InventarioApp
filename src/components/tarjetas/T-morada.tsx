...
export function TarjetaM() {
  return (
    <Card className="text-white shadow-[0_10px_20px_rgba(0,0,0,0.2)] cursor-pointer hover:contrast-100 hover:scale-110 duration-150">
      <CardContent className="w-full flex items-center bg-indigo-700 p-0">
        <CardHeader className="w-3/6 pr-0">
          {/* Cantidad almacenada (fluctuante)*/}
          <CardTitle className="text-5xl">10186</CardTitle>
      ...
      <CardFooter className="flex items-center justify-center bg-indigo-900 py-2">
