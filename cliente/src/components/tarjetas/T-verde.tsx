...
export function TarjetaV() {
  return (
    <Card className="text-white shadow-[0_10px_20px_rgba(0,0,0,0.2)] cursor-pointer hover:contrast-100 hover:scale-110 duration-150">
      <CardContent className="w-full flex items-center bg-[rgb(63,165,100)] p-0">
        <CardHeader className="w-3/6 pr-0">
          {/* Cantidad almacenada (fluctuante)*/}
          <CardTitle className="text-5xl">31</CardTitle>
      ...
      <CardFooter className="flex items-center justify-center bg-[rgb(61,124,85)] py-2">
